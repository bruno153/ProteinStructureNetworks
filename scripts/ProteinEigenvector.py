# Software designed to calculate eigenvector centrality
...
# Output: Eigenvector list in txt file
#         Event log in txt file
#
# python ProteinEigenvector.py
# Insert file name:
# 4dc2_no_substrate
# Done Model
# Done LOL
...
out = open((name + "_eigenvector.txt"), "w")

text = open((name + ".pdb"), "r")

log = open((name + "_eigenvector_log.txt"), "w")
